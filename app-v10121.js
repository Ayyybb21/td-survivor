...
function renderPickHero(){
  ...
  const accent=noPick ? "#f6c515" : hasPick ? "#22c96b" : "#ff7d88";
  const darkAccent=noPick ? "#7a6100" : hasPick ? "#075c32" : "#642631";
  ...
  hero.style.background=noPick
    ? "radial-gradient(circle at 84% 30%,rgba(246,197,21,.18),transparent 26%),linear-gradient(135deg,#0b1017,#111923)"
    : hasPick
      ? "radial-gradient(circle at 84% 30%,rgba(34,201,107,.18),transparent 26%),linear-gradient(135deg,#07150f,#101923)"
      : "linear-gradient(135deg,#1b0d12,#101923)";
  ...
  hero.innerHTML=`
    <div style="display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center;">
      <div style="min-width:0;">
        <span class="pill" style="background:${accent}22;color:${accent};border:1px solid ${accent}44;">
