...
function ensureChatUI(){
  ...
  chat.style.cssText="position:fixed;inset:0 0 calc(64px + env(safe-area-inset-bottom)) 0;z-index:20;background:#07111f;overflow:hidden;padding:calc(env(safe-area-inset-top) + 10px) 12px 6px;";
  chat.innerHTML=`
  ...
  if(nav){
    ...
    nav.style.padding="6px 4px max(6px,env(safe-area-inset-bottom))";
