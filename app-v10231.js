...
function renderSunday(){
  ...
  el.innerHTML=`
    ...
    <div class="card" style="margin-top:12px;padding:16px;border:1px solid #2b2f34;background:#08090a;">
      ...
      <div style="font-size:15px;font-weight:950;margin-top:4px;">Coming next</div>
      <div style="font-size:9px;color:#8f99a4;line-height:1.5;margin-top:6px;">This area is reserved for live TD detections, game status and the league-wide Sunday tracker. Official survivor grading remains commissioner-controlled.</div>
    </div>`;
}
...
document.querySelectorAll(".navbtn").forEach(b=>{
  b.onclick=async()=>{
    ...
    if(b.dataset.view==="sundayView")renderSunday();
