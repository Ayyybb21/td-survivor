...
const PLAYER_CACHE_KEY = "td_nfl_player_pool_v10";
const PLAYER_CACHE_TIME_KEY = "td_nfl_player_pool_v10_time";
...
function normalizeSleeperPlayers(raw){
  ...
  Object.values(raw||{}).forEach(p=>{
    ...
    const item={
      ...
      rank:Number.isFinite(Number(p.search_rank)) ? Number(p.search_rank) : 99999
    };
