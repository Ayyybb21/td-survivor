  ...
  chat.innerHTML=`
    <div style="padding-bottom:88px;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
        <div>
          <div style="font-size:16px;font-weight:950;">💬 League Chat</div>
          <div style="font-size:9px;color:#78879a;margin-top:2px;">TD Survivor • league room</div>
        </div>
        <div id="chatLive" style="font-size:8px;color:#5be69d;font-weight:900;">● LIVE</div>
      </div>
      <div id="chatMessages" style="height:calc(100vh - 265px);min-height:330px;overflow:auto;padding:2px 0 10px;"></div>
      <div style="position:sticky;bottom:72px;background:#07111f;padding-top:8px;">
        <div style="display:flex;gap:7px;align-items:stretch;">
          <textarea id="chatInput" maxlength="500" rows="2" placeholder="Message the league…"
            style="flex:1;resize:none;background:#0c1828;color:#fff;border:1px solid #293b53;border-radius:12px;padding:10px;font:inherit;"></textarea>
          <button id="chatSend" class="primary" style="width:auto;padding:0 14px;">Send</button>
        </div>
        <div style="font-size:8px;color:#657489;margin-top:5px;">Posts under your owner name.</div>
      </div>
    </div>`;
...
async function sendChatMessage(){
  ...
  try{
    const proof=await post("chatProof",{token:OWNER_TOKEN});
