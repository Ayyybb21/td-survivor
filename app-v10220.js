    ...
    panel.innerHTML=`
      ...
      <div style="font-size:8px;color:${cfg.triggerInstalled?"#42dc88":"#f0b45d"};margin-top:9px;line-height:1.4;">
        ${cfg.triggerInstalled
          ?"✅ Scheduled reminder engine installed."
          :"⚠️ Scheduled reminder engine is NOT installed yet. The 24h / 3h / 30m reminders require a one-time Apps Script install."}
      </div>
