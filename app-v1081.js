...
function ensureChatUI(){
  ...
  chat.style.cssText="position:fixed;inset:0 0 58px 0;z-index:20;background:#07111f;overflow:hidden;padding:calc(env(safe-area-inset-top) + 10px) 12px 6px;";
  chat.innerHTML=`
  ...
  if(nav){
    nav.style.display="grid";nav.style.gridTemplateColumns="repeat(5,minmax(0,1fr))";nav.style.gap="2px";
    nav.style.paddingLeft="4px";nav.style.paddingRight="4px";
    nav.querySelectorAll(".navbtn").forEach(btn=>{btn.style.minWidth="0";btn.style.width="100%";btn.style.padding="8px 2px";btn.style.fontSize="9px";btn.style.whiteSpace="nowrap";});
  }
