  ...
  wrap.innerHTML=`
    <div style="max-width:460px;margin:0 auto;">
      ...
      <div style="margin-top:24px;padding:18px;border:1px solid #a83d00;border-radius:16px;background:linear-gradient(180deg,#101317,#0c0e11);">
        ...
        <label style="display:block;margin-top:16px;font-size:8px;color:#9aa3ad;font-weight:900;">YOUR NAME</label>
        <input id="joinName" autocomplete="name" maxlength="40" placeholder="First and last name"
